...
(() => {
  ...
  MathPetCharacters.register({
    id:'wukong',name:'孙悟空',portrait:'assets/stage-1-portrait.png?v=cute-agile-hero4',unlock:{cost:200,description:'使用 200 积分兑换'},food:{name:'桃子',unit:'颗',icon:'🍑',title:'一颗甜桃，长大一点',cost:20,growth:20},
