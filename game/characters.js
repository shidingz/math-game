...
(() => {
  ...
  MathPetCharacters.register({
    id:'wukong',name:'孙悟空',portrait:'assets/stage-1-portrait.png?v=cute-agile-hero4',unlock:{cost:300,description:'使用 300 积分兑换'},food:{name:'桃子',unit:'颗',icon:'🍑',title:'一颗甜桃，长大一点',cost:20,growth:20},
    ...
    clickActions:['skill','pet','jump','celebrate','skill','wave'],idleActions:['think','skill','jump','wave','sleep'],
    messages:{idle:['一起做题，攒桃子吧！','今天也想和你一起进步。'],pet:['好伙伴，默契又进了一步。','有你陪着，真开心。'],wave:['嗨，伙伴！','随时准备，一起出发！'],jump:['看我的腾云身法！','活动一下，更有精神。'],celebrate:['我们真是好搭档！','击个掌，继续加油！'],skill:['看，我的新本领！','一起成长，一起变强。'],think:['下一道题，咱们一起想。','嗯……桃子要怎么分呢？'],sleep:['眯一小会儿……','休息一下，再一起出发。']},
    create({level}){
