...
(() => {
  ...
  MathPetCharacters.register({
    id:'nezha',name:'哪吒',portrait:'characters/nezha/assets/stage-1-portrait.png?v=realistic2-martial',unlock:{cost:300,description:'使用 300 积分兑换'},
    ...
    clickActions:['pet','wave','jump','celebrate','skill'],idleActions:['think','wave','skill','jump'],
    messages:{idle:['一起做题，攒莲花酥吧！','准备好了，我们一起出发！'],pet:['好搭档，交给我！','并肩前行，一起变强。'],wave:['伙伴，我在这儿！','今天也一起加油！'],jump:['看我的轻功！','活动一下，再来一道。'],celebrate:['好搭档，这次配合得漂亮！','我们又进步了一点！'],skill:['看我的风火武艺！','一起学本领，一起变强。'],think:['这道题，咱们一起想。','看清楚，再出招。'],sleep:['歇一小会儿……','养足精神，再一起出发。']},
    create({level}){
